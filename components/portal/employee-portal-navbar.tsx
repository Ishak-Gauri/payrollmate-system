...
import { Menu, X, User, LogOut, Moon, Sun, FileText, Home } from "lucide-react"
...
export function EmployeePortalNavbar() {
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/portal" className="flex items-center">
                ...
                <span className="ml-2 text-sm bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 px-2 py-0.5 rounded-md">
                  Employee Portal
                </span>
              </Link>
            </div>
